...
function AddCoupon() {
  ...
  const handleDelete = async (deleteId) => {
    ...
    try {
      await api.delete(`/coupons/admin/delete/${deleteId}`);
      ...
      {confirmModal && (
              <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-[32px] p-8 max-w-sm w-full shadow-2xl">
                  <h3 className="text-2xl font-black text-[#6B3F1F] mb-4">Delete Coupon?</h3>
                  <p className="text-gray-600 mb-8 font-medium">Are you sure you want to delete this coupon? This action cannot be undone.</p>
